                            ...
                            <table style="font-family: 'Montserrat',Arial,sans-serif; width: 100%;" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                                <tr>
                                    <td class="sm-px-24" style="background-color: #ffffff; border-radius: 4px; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 14px; line-height: 24px; padding: 48px; text-align: left; color: black;">
                                        <p style="font-weight: 700; font-size: 24px; margin-top: 0; color: #ff5850; text-align: center;">
                                            Contact Us Form
                                        </p>
                                        <div class="row">
                                            <div class="form-group col-md-8" style="padding-top: 18px;">
                                                <label style="font-size: 18px;">Hi! My name is</label>
                                                <input name="" type="text"
                                                       value="{{$data['name']}}"
                                                       style="margin-top: 13px;display: block;width: 100%;height: calc(1.5em + .75rem + 2px);padding: .375rem .75rem;font-size: 1rem;font-weight: 400;line-height: 1.5;color: black;background-color: #e9ecef;background-clip: padding-box;border: 1px solid #ced4da;border-radius: .25rem;transition: border-color .15s ease-in-out,box-shadow .15s ease-in-out;"
                                                       disabled>
                                            </div>
                                            <div class="form-group col-md-8" style="padding-top: 18px;">
                                                <label style="font-size: 18px;">My email is</label>
                                                <input name="" type="text"
                                                       value="{{$data['email']}}"
                                                       style="margin-top: 13px;display: block;width: 100%;height: calc(1.5em + .75rem + 2px);padding: .375rem .75rem;font-size: 1rem;font-weight: 400;line-height: 1.5;color: black;background-color: #e9ecef;background-clip: padding-box;border: 1px solid #ced4da;border-radius: .25rem;transition: border-color .15s ease-in-out,box-shadow .15s ease-in-out;"
                                                       disabled>
                                            ...
                                            <div class="form-group col-md-4" style="padding-top: 18px;">
                                                <label style="font-size: 18px;">My phone number is</label>
                                                <input name="" type="text"
                                                       value="{{$data['phone']}}"
                                                       style="margin-top: 13px;display: block;width: 100%;height: calc(1.5em + .75rem + 2px);padding: .375rem .75rem;font-size: 1rem;font-weight: 400;line-height: 1.5;color: black;background-color: #e9ecef;background-clip: padding-box;border: 1px solid #ced4da;border-radius: .25rem;transition: border-color .15s ease-in-out,box-shadow .15s ease-in-out;"
                                                       disabled>
                                            ...
                                            <div class="form-group col-md-6" style="padding-top: 18px;">
                                                <label style="font-size: 18px;">I’d like to share more details:</label>
                                                <span style="font-size: 1rem;margin-top: 13px;display: block;width: 100%;overflow: hidden;resize: both;min-height: 40px;line-height: 20px;pointer-events: none;background-color: #eaecef;padding: 0.438rem 1rem;color: #000000;background-clip: padding-box;border: 1px solid #d8d6de;border-radius: 0.357rem;transition: border-color 0.15s ease-in-out, box-shadow 0.15s ease-in-out;text-align: justify;"
                                                      class="textarea" role="textbox" disabled>
                                                    {{$data['message']}}
                                                </span>
                                            </div>
                                        </div>
                                        <p style="margin: 0 0 16px;padding-top: 18px;font-size: 15px;">Thanks, <br>The 80/20 Eatery Team</p>
                                    </td>
                                </tr>
                                <tr>
