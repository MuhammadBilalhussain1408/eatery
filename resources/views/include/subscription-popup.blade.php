                ...
                <form onsubmit="checkForm(this);" id="subscriptionForm">
                    <div class="form-group">
                            ...
                            <input class="subscription-input-fields"
                                   ...
                                   <h6 class="text-white pt-3 d-none" id="emailPopupError"></h6>
                    ...
                    <div class="pt-3">
                        <input style="width: 62%;border-radius: 7px;" name="abrform" id="abrformSub" class="primary-btn" type="submit" value="Subscribe Now">
                    </div>
                </form>
            </div>
        </div>
