...
{{--                        </div>--}}
                        <h1 class="title_one hero-heading text-capitalize">
                            building economics, <span> bold flavors, </span> thriving creators
                        </h1>
                        <p class="">
                            At 80/20 Eatery, Our space is more than just a place to gather—it’s a hub where ideas are exchanged, connections are made,
                            and culture thrives. Here, wealth-building meets unforgettable experiences, and every flavor sparks joy.
                        </p>
                        <div class="hero-btn-group-2">
                            <a href="javascript:void(0);" class="primary-btn">learn more</a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-6">
                            <div class="counter-single-2">
                                ...
                                <h6 class="counter-text">Orders complete</h6>
                            </div>
                        </div>
                        <div class="col-lg-3 col-6">
                            <div class="counter-single-2">
                                <div class="counter-number">
                                    <span class="counter">98,000</span>
                                </div>
                        ...
                        <div class="col-lg-3 col-6">
                            <div class="counter-single-2">
                                ...
                                <h6 class="counter-text">Clients served</h6>
                            </div>
                        </div>
                    </div>
                </div>
